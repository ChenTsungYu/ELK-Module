# AWS API 串接至 Elasticsearch
## Resource
- [Billing Cost Optimizing](./Cost/cost_optimizing.py)   [Cost Optimizing 示意圖](./Resource/image/aws_cost_optimizing.png)
- [EC2](./Resource/ec2.py) [示意圖](./Resource/image/AWS_ec2_resource.png)
- [RDS](./Resource/rds.py) [示意圖](./Resource/image/AWS_rds_resource.png)
- [Config - Resource](./Resource/config_resource.py)、[Config - Compliance - Resource](./Resource/config_compliance_resource.py) 、[Config - Compliance - Rule](./Resource/config_compliance_rule.py)  [示意圖](./Resource/image/AWS_config_resource.png)
